...
public class FoodMarketItemPanel extends AMarketItemPanel {
   ...
   public FoodMarketItemPanel(float x, float y, IShopDialog shopDialog, FoodMarketItem foodMarketItem, ICargoManager cargoManager) {
      super(x, y, shopDialog, ResourceManager.getInstance().getFoodIconTextureRegion(), foodMarketItem, cargoManager);
   }
