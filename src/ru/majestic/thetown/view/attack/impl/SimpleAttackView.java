...
public class SimpleAttackView extends Sprite implements IAttackView, OnClickListener {   
   ...
   public SimpleAttackView() {
      ...
      resultText            = new Text(0, PANEL_PADDING, FontsManager.getInstance().getFont(28), "You've been attacked!", ResourceManager.getInstance().getEngine().getVertexBufferObjectManager());
      ...
      woodResultText        = new Text(woodIcon.getX() + woodIcon.getWidth() + 4, woodIcon.getY() + 8, FontsManager.getInstance().getFont(18), "+100.00TT", 25, ResourceManager.getInstance().getEngine().getVertexBufferObjectManager());
      ...
      foodResultText        = new Text(foodIcon.getX() + foodIcon.getWidth() + 4, foodIcon.getY() + 8, FontsManager.getInstance().getFont(18), "+100.00TT", 25, ResourceManager.getInstance().getEngine().getVertexBufferObjectManager());
